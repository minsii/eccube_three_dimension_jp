...
<!--{if $smarty.const.USE_CUSTOMER_COMPANY === true}-->
	...
	<input type="text" name="company" value="<!--{$arrForm.company|h}-->" istyle="1"><br>

	●法人名(フリガナ)<br>
	<font color="#FF0000"><!--{$arrErr.company_kana}--></font>
	<input type="text" name="company_kana" value="<!--{$arrForm.company_kana|h}-->" istyle="2"><br>
<!--{*
	●部署名<br>
	<font color="#FF0000"><!--{$arrErr.company_department}--></font>
	<input type="text" name="company_department" value="<!--{$arrForm.company_department|h}-->" istyle="1"><br>
*}-->
<!--{/if}-->
<!--{*## 顧客法人管理 ADD END ##*}-->
