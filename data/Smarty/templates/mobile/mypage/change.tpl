...
<!--{if $smarty.const.USE_CUSTOMER_COMPANY === true}-->
	<font color="#FF0000"><!--{$arrErr.company}--></font>
	法人名<br>
	<input type="text" name="company" value="<!--{$arrForm.company|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" istyle="1"><br>

	<font color="#FF0000"><!--{$arrErr.company_kana}--></font>
	法人名(フリガナ)<br>
	<input type="text" name="company_kana" value="<!--{$arrForm.company_kana|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" istyle="1"><br>

	<font color="#FF0000"><!--{$arrErr.company_department}--></font>
<!--{*
	部署名<br>
	<input type="text" name="company_department" value="<!--{$arrForm.company_department|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" istyle="1"><br><br>
*}-->
<!--{/if}-->
<!--{*## 顧客法人管理 ADD END ##*}-->
