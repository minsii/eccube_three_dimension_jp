...
<li<!--{if $tpl_subno == 'extra_class'}--> class="on"<!--{/if}--> id="navi-products-extra-class"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/extra_class.php"><span>追加規格管理</span></a></li>
<!--{/if}-->
<!--{*## 追加規格 ADD END ##*}-->
