...
/*######################■商品マスタ一覧で規格有無表示■######################*/
INSERT INTO  mtb_constants (id ,name ,rank ,remarks) VALUES ('USE_PRODUCT_MASTER_CHECK_CLASS',  'true',  (SELECT MAX(rank)+1 FROM mtb_constants),  '商品マスタ一覧で規格有無表示機能を使用するフラグ|true:使用');